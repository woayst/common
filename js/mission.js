        ...
        mission
          ...
          .then(function () {
            ...
            output.renderQuestion = function renderQuestion(template_id) {
              ...
              $("#box-question").html(tmpl(template, question));
