...
if (client.reward.hasLogin) {
    console.log('has login');
    initMission();
} else {
    console.log('not has login');
...
function fetchMission() {
    console.trace('fetchMission');
    var missions = client.mission.getAll();
    $('#w-text-share-url').val(getShareLink());
    if (mobileAndTabletCheck()) {
        console.log('render mission in mobile');
        renderMissions(missions, 'm-mission-tmpl');
    } else {
        console.log('render mission in desktop');
